...
contract Create
{
    ...
    , string memory _ipfs) public{
        require(votingOrganizer == msg.sender, "Only organiser can create the candidate");
    ...
    function getCandidatedata(address _address) public view returns(string memory, string memory, uint256,
    string memory, uint256, string memory, address){
        return (
    ...
    function getVotingOrganizer() public view returns (address) 
    {
